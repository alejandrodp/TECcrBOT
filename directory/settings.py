...
DEPT_PAGES = PageTy(ty=DEPT_TY, model=Unit, desc='Departamentos',
                    index=index_depts, build=depts_page_builder)

LOC_PAGES = PageTy(ty=LOC_TY, model=Location, desc='Campuses',
                   index=index_locs, build=loc_builder)
