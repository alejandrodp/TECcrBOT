...
from .handlers import menu_entry, select_place, get_place, handlers, first_category_list, States, remain_category_list
...
handlers.add_callback_query_handler(remain_category_list, States.SELECT_CATEGORY, r'(\d+)')
