from tcrb.menu import main_menu_entry
from .handlers import main_entry, categories_list, news_list, previous_page, next_page, get_article, handlers
...
handlers.add_callback_query_handler(
    previous_page, 'previous_articles', r'\d+', r'\d+')
