...
HANDLERS = [
    ...
    CallbackQueryHandler(categories_list, pattern=f'{apps.NewsConfig.name}:last_news:'),
    CallbackQueryHandler(news_list, pattern=rf'{apps.NewsConfig.name}:category_list:\d*'),
